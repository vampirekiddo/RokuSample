...
sub fireEvent(event)
    if event.getNode() = "playPause"
        ...
        m.top.navigationEvents.back15 = not m.top.navigationEvents.back15
    else if event.getNode() = "forward15"
        m.top.navigationEvents.forward15 = not m.top.navigationEvents.forward15
    else if event.getNode() = "CC"
        m.top.navigationEvents.CC = not m.top.navigationEvents.CC
    end if
end sub
